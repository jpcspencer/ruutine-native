...
struct GlossaryView: View {
    ...
    @State private var localCustomExercises: [Exercise] = []
    @State private var showAddCustom = false
    @State private var customExerciseName = ""

    private var allExercises: [Exercise] {
        exerciseService.exercises + localCustomExercises
    }
    ...
    private func addCustomExercise() {
        ...
        let exercise = Exercise(
            id: "custom-\(trimmed.lowercased().replacingOccurrences(of: " ", with: "-"))",
            name: trimmed,
        ...
        localCustomExercises.append(exercise)
        customExerciseName = ""
    }
